...
<body>
	{if !isset($HOOK_COMING_SOON)}
		{capture name="displayComingSoon"}{hook h="displayComingSoon"}{/capture}
	{/if}
	{if (isset($HOOK_COMING_SOON) && $HOOK_COMING_SOON|trim) || (isset($smarty.capture.displayComingSoon) && $smarty.capture.displayComingSoon|trim)}
		<div id="coming_soon_container">
			{if isset($HOOK_COMING_SOON)}{$HOOK_COMING_SOON}{/if}
			{if isset($smarty.capture.displayComingSoon)}{$smarty.capture.displayComingSoon}{/if}			
		</div>
	{else}
	<div class="container">
		<div id="maintenance">
