...
<form action="{$link->getModuleLink('cashondelivery', 'validation', [], true)|escape:'html'}" method="post">
    ...
    <p class="cart_navigation clearfix" id="cart_navigation">
        <a href="{$link->getPageLink('order', true)}?step=3" class="button-exclusive btn btn-default pull-left">{l s='Other payment methods' mod='cashondelivery'}</a>
        <button type="submit" class="btn btn-default pull-right">{l s='I confirm my order' mod='cashondelivery'}</button>
    </p>
</form>
