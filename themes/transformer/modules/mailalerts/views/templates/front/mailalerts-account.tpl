...
<div id="mailalerts_block_account" class="block">
		...
		<ul class="products-block">
			...
			<li class="clearfix{if $smarty.foreach.myLoop.last} last_item{/if}">
                ...
                <div class="product-content">
                	<span class="remove">
                        <i class="icon-cancel icon-small" rel="ajax_id_mailalert_{$mailAlert.id_product}_{$mailAlert.id_product_attribute}"></i>
                    </span>
	...
	<ul class="footer_links clearfix">
		<li class="pull-left">
			<a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Back to Your Account' mod='mailalerts'}" rel="nofollow">
				<i class="icon-left icon-mar-lr2"></i>{l s='Back to Your Account' mod='mailalerts'}
			</a>
		</li>
		<li class="pull-right">
			<a href="{$base_dir}" title="{l s='Home' mod='mailalerts'}" rel="nofollow">
				<i class="icon-home icon-mar-lr2"></i>{l s='Home' mod='mailalerts'}
			</a>
		</li>
	</ul>
</div>
