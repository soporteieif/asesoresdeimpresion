...
{capture name=path}
	<li><a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}" title="{l s='Go back to the Checkout' mod='cheque'}">{l s='Checkout' mod='cheque'}</a></li><li class="navigation-pipe">{$navigationPipe}</li><li><span>{l s='Check payment' mod='cheque'}</span></li>
{/capture}
