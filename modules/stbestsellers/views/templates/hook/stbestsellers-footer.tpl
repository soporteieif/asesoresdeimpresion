...
<section id="best_sellers_footer_{$hook_hash}" class="best_sellers_footer block col-sm-12 col-md-3">
    <div class="title_block"><div class="title_block_name">{l s='Top sellers' mod='stbestsellers'}</div><a href="javascript:;" class="opener dlm">&nbsp;</a></div>
