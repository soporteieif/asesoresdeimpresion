...
<section id="featured_products_footer_{$hook_hash}" class="featured_products_footer block col-sm-12 col-md-3">
    <div class="title_block"><div class="title_block_name">{l s='Featured Products' mod='homefeaturedslider'}</div><a href="javascript:;" class="opener dlm">&nbsp;</a></div>
