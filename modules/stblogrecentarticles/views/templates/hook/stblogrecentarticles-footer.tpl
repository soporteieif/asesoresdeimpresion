...
<section id="st_blog_recent_article-footer_{$hook_hash}" class="st_blog_recent_article-footer block col-sm-12 col-md-3">
    <div class="title_block"><div class="title_block_name">{l s='Recent articles' mod='stblogrecentarticles'}</div><a href="javascript:;" class="opener dlm">&nbsp;</a></div>
