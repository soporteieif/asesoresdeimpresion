...
{if isset($p) AND $p}
	...
	{if $start!=$stop}
		...
		{if $p != 1}
			...
			<li class="pagination_previous"><a {$no_follow_text} href="{$link->goPage($requestPage, $p_previous)}" title="{l s='Previous' mod='stblogsearch'}">&lt;</a></li>
		{else}
		...
		{if $pages_nb > 1 AND $p != $pages_nb}
			...
			<li class="pagination_next"><a {$no_follow_text} href="{$link->goPage($requestPage, $p_next)}" title="{l s='Next' mod='stblogsearch'}">&gt;</a></li>
		{else}
