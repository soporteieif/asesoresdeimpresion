...
<section id="facebook_like_box_footer" class="col-sm-12 col-md-{if $st_fb_lb_wide_on_footer}{$st_fb_lb_wide_on_footer}{else}3{/if} block">
    <div class="title_block"><div class="title_block_name">{l s='Facebook' mod='stfblikebox'}</div><a href="javascript:;" class="opener dlm">&nbsp;</a></div>
