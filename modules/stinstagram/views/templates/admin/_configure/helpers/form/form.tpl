			...
			<div class="row">
				{foreach $input.values.medias AS $media}
					<div class="col-xs-4 col-sm-3">
						<label data-html="true" data-toggle="tooltip" class="label-tooltip" data-original-title="{if $media=='fw'}{l s='If this is set and this module is hooked to the displayFullWidthXXX hooks, then this module will be displayed in full width.'}{elseif $media=='xl'}{l s='Desktops (>1400px)'}{elseif $media=='lg'}{l s='Desktops (>1200px)'}{elseif $media=='md'}{l s='Desktops (>992px)'}{elseif $media=='sm'}{l s='Tablets (>768px)'}{elseif $media=='xs'}{l s='Phones (>480px)'}{elseif $media=='xxs'}{l s='Phones (<480px)'}{/if}">{if $media=='fw'}{l s='Full width'}{elseif $media=='xl'}{l s='Extra large devices'}{elseif $media=='lg'}{l s='Large devices'}{elseif $media=='md'}{l s='Medium devices'}{elseif $media=='sm'}{l s='Small devices'}{elseif $media=='xs'}{l s='Extra small devices'}{elseif $media=='xxs'}{l s='Extremely small devices'}{/if}</label>
