...
<section id="new_products_footer_{$hook_hash}" class="new_products_footer block col-sm-12 col-md-3">
    <div class="title_block"><div class="title_block_name">{l s='New products' mod='sthomenew'}</div><a href="javascript:;" class="opener dlm">&nbsp;</a></div>
